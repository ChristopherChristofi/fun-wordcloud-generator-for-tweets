...
stage_db_host=os.getenv("STAGE_HOST") or "CHANGEME"
stage_db_port=os.getenv("STAGE_PORT") or "CHANGEME"
...
stage_nlp_processed_csv = "./data/stage_data/stage_nlp_tweets.csv"

stage_mg_db_user=os.getenv("STAGE_MG_USER") or "CHANGEME"
stage_mg_db_pass=os.getenv("STAGE_MG_PASS") or "CHANGEME"
stage_mg_db_host=os.getenv("STAGE_MG_HOST") or "CHANGEME"
stage_mg_db_port=os.getenv("STAGE_MG_PORT") or "CHANGEME"